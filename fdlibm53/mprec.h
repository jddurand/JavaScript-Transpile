...
/* Ten_pmax = fdlibm_floor(P*fdlibm_log(2)/fdlibm_log(5)) */
/* Bletch = (highest power of 2 < DBL_MAX_10_EXP) / 16 */
/* Quick_max = fdlibm_floor((P-1)*fdlibm_log(FLT_RADIX)/fdlibm_log(10) - 1) */
/* Int_max = fdlibm_floor(P*fdlibm_log(FLT_RADIX)/fdlibm_log(10) - 1) */
